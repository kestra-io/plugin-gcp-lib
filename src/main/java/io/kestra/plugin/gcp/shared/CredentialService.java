...
public final class CredentialService {
    ...
    /**
     * Resolves the effective GCP project id: the explicitly configured one if present,
     * otherwise the project id inferred from service-account credentials. Pure: never mutates its arguments.
     */
