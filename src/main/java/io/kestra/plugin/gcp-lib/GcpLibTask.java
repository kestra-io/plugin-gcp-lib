package io.kestra.plugin.gcp-lib;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.gcp-lib.GcpLibTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class GcpLibTask extends Task implements RunnableTask<GcpLibTask.Output> {
    @Schema(
    ...
    @Override
    public GcpLibTask.Output run(RunContext runContext) throws Exception {
